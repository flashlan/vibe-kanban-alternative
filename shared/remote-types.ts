...
export type ProjectStatus = { id: string, project_id: string, name: string, color: string, sort_order: number, hidden: boolean, is_terminal: boolean, created_at: string, };
 ...
 * Using client-generated IDs enables stable optimistic updates.
 */
id?: string, project_id: string, name: string, color: string, sort_order: number, hidden: boolean, is_terminal?: boolean, };

export type UpdateProjectStatusRequest = { name: string | null, color: string | null, sort_order: number | null, hidden: boolean | null, is_terminal: boolean | null, };
